...
//When we flush the rewrite rules, check and see if we need to add our rule
add_action('generate_rewrite_rules', 'taveo_add_rewrites');
function taveo_add_rewrites() {
    global $wp_rewrite;
